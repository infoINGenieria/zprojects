 ...
 * @author matu
 */
public class TablaDatosTransporte  extends AbstractTableModel {

    private LinkedList datos = new LinkedList();
    private LinkedList listeners = new LinkedList();

    public TablaDatosTransporte(){
        super();
    ...
    public void addRegistro (Materiales mat)
    {
        datos.add (mat);
    ...
    public void delRegistro (Materiales mat)
    {
        datos.remove(mat);
    ...
    public void insertarFila(Materiales value, int row) {
        datos.remove(row);
        datos.add(row, value);
...
try{
    ...
    public Materiales getFila(int row){
        return (Materiales)(datos.get(row));
    }
